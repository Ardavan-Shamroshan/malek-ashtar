    ...
    var t = {
        5927: (t, e, i) => {
            ...
            var m = function () {
                ...
                return n(t, [{
                    key: "shadeRGBColor", value: function (t, e) {
                        var i = e.split(","), a = t < 0 ? 0 : 255, s = t < 0 ? -1 * t : t,
                            r = parseInt(i[0].slice(4), 10), o = parseInt(i[1], 10), n = parseInt(i[2], 10);
                ...
                return n(t, [{
                    ...
                    key: "dropShadow", value: function (t, e) {
                        var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 0, a = e.top,
                            s = e.left, r = e.blur, o = e.color, n = e.opacity, l = e.noUserSpaceOnUse, h = this.w;
                ...
                return n(t, [{
                    ...
                    key: "drawPath", value: function (t) {
                        var e = t.d, i = void 0 === e ? "" : e, a = t.stroke, s = void 0 === a ? "#a8a8a8" : a,
                            ...
                            u = t.strokeLinecap, p = void 0 === u ? null : u, f = t.strokeDashArray,
                            x = void 0 === f ? 0 : f, b = this.w;
                    ...
                    key: "renderPaths", value: function (t) {
                        var e, i = t.j, a = t.realIndex, s = t.pathFrom, r = t.pathTo, o = t.stroke, n = t.strokeWidth,
                            l = t.strokeLinecap, h = t.fill, d = t.animationDelay, g = t.initialSpeed,
                            u = t.dataChangeSpeed, p = t.className, f = t.shouldClipToGrid, x = void 0 === f || f,
                            b = t.bindEventsOnPaths, m = void 0 === b || b, w = t.drawShadow, k = void 0 === w || w,
                            A = this.w, S = new y(this.ctx), C = new v(this.ctx),
                        ...
                        if (I.attr("index", a), x && I.attr({"clip-path": "url(#gridRectMask".concat(A.globals.cuid, ")")}), "none" !== A.config.states.normal.filter.type) S.getDefaultFilter(I, a); else if (A.config.chart.dropShadow.enabled && k && (!A.config.chart.dropShadow.enabledOnSeries || A.config.chart.dropShadow.enabledOnSeries && -1 !== A.config.chart.dropShadow.enabledOnSeries.indexOf(a))) {
                    ...
                    key: "drawText", value: function (t) {
                        var e, i = t.x, a = t.y, s = t.text, r = t.textAnchor, o = t.fontSize, n = t.fontFamily,
                            l = t.fontWeight, h = t.foreColor, c = t.opacity, d = t.cssClass, g = void 0 === d ? "" : d,
                            u = t.isPlainText, p = void 0 === u || u, f = this.w;
                    ...
                    key: "pathMouseEnter", value: function (t, e) {
                        var i = this.w, a = new y(this.ctx), s = parseInt(t.node.getAttribute("index"), 10),
                ...
                return n(t, [{
                    ...
                    key: "addBackgroundToAnno", value: function (t, e) {
                        ...
                        var a = i.globals.dom.baseEl.querySelector(".apexcharts-grid").getBoundingClientRect(),
                            ...
                            o = e.label.style.padding.right, n = e.label.style.padding.top,
                ...
                return n(t, [{
                    key: "addPointAnnotation", value: function (t, e, i) {
                        ...
                        if (a.config.yaxis[t.yAxisIndex].logarithmic) h = (n = new S(this.annoCtx.ctx).getLogVal(n, t.yAxisIndex)) / a.globals.yLogRatio[t.yAxisIndex]; else {
                        ...
                        if (r = a.globals.gridHeight - h - parseFloat(t.label.style.fontSize) - t.marker.size, o = a.globals.gridHeight - h, a.config.yaxis[t.yAxisIndex] && a.config.yaxis[t.yAxisIndex].reversed && (r = h + parseFloat(t.label.style.fontSize) + t.marker.size, o = h), m.isNumber(s)) {
                            ...
                            var v = t.label.text ? t.label.text : "", y = this.annoCtx.graphics.drawText({
                                x: s + t.label.offsetX,
                                y: r + t.label.offsetY,
                                text: v,
                                textAnchor: t.label.textAnchor,
                ...
                options: {
                    ...
                    shortMonths: ['مهر', 'آبان', 'آذر', 'دی', 'بهمن', 'اسفند', 'فروردین', 'اردیبهشت', 'خرداد'],
                ...
                return n(t, [{
                    ...
                    key: "addText", value: function (t, e) {
                        var i = t.x, a = t.y, s = t.text, r = t.textAnchor, o = t.foreColor, n = t.fontSize,
                            l = t.fontFamily, h = t.fontWeight, c = t.cssClass, d = t.backgroundColor,
                            g = t.borderWidth, u = t.strokeDashArray, p = t.borderRadius, f = t.borderColor,
                            x = t.appendTo, b = void 0 === x ? ".apexcharts-annotations" : x, m = t.paddingLeft,
                            v = void 0 === m ? 4 : m, y = t.paddingRight, w = void 0 === y ? 4 : y, k = t.paddingBottom,
                            A = void 0 === k ? 2 : k, S = t.paddingTop, C = void 0 === S ? 2 : S, L = this.w,
                    ...
                    key: "addImage", value: function (t, e) {
                        var i = this.w, a = t.path, s = t.x, r = void 0 === s ? 0 : s, o = t.y,
                            n = void 0 === o ? 0 : o, l = t.width, h = void 0 === l ? 20 : l, c = t.height,
                            d = void 0 === c ? 20 : c, g = t.appendTo, u = void 0 === g ? ".apexcharts-annotations" : g,
                    ...
                    key: "addAnnotationExternal", value: function (t) {
                        var e = t.params, i = t.pushToMemory, a = t.context, s = t.type, r = t.contextMethod, o = a,
                            n = o.w, l = n.globals.dom.baseEl.querySelector(".apexcharts-".concat(s, "-annotations")),
                            h = l.childNodes.length + 1, c = new T,
                ...
                return n(t, [{
                    ...
                    key: "handlePatternFill", value: function (t, e, i, a) {
                        var s = this.w.config, r = this.opts, o = new w(this.ctx),
                    ...
                    key: "handleGradientFill", value: function (t, e, i) {
                        var a, s = this.w.config, r = this.opts, o = new w(this.ctx), n = new m,
                            l = s.fill.gradient.type, h = t,
                        ...
                        if (void 0 === s.fill.gradient.gradientToColors || 0 === s.fill.gradient.gradientToColors.length) a = "dark" === s.fill.gradient.shade ? n.shadeColor(-1 * parseFloat(s.fill.gradient.shadeIntensity), t.indexOf("rgb") > -1 ? m.rgb2hex(t) : t) : n.shadeColor(parseFloat(s.fill.gradient.shadeIntensity), t.indexOf("rgb") > -1 ? m.rgb2hex(t) : t); else if (s.fill.gradient.gradientToColors[r.seriesNumber]) {
                ...
                return n(t, [{
                    ...
                    key: "plotChartMarkers", value: function (t, e, i, a) {
                        var s, r = arguments.length > 4 && void 0 !== arguments[4] && arguments[4], o = this.w, n = e,
                            l = t, h = null, c = new w(this.ctx);
                        if ((o.globals.markers.size[e] > 0 || r) && (h = c.group({class: r ? "" : "apexcharts-series-markers"})).attr("clip-path", "url(#gridRectMarkerMask".concat(o.globals.cuid, ")")), Array.isArray(l.x)) for (var d = 0; d < l.x.length; d++) {
                            var g = i;
                    ...
                    key: "getMarkerConfig", value: function (t, e) {
                        var i = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : null, a = this.w,
                            s = this.getMarkerStyle(e), r = a.globals.markers.size[e], o = a.config.markers;
                ...
                return n(t, [{
                    key: "draw", value: function (t, e, i) {
                        var a = this.w, s = new w(this.ctx), r = i.realIndex, o = i.pointsPos, n = i.zRatio,
                            l = i.elParent,
                    ...
                    key: "drawPoint", value: function (t, e, i, a, s, r, o) {
                        var n, l = this.w, h = s, c = new v(this.ctx), d = new y(this.ctx), g = new z(this.ctx),
                            u = new I(this.ctx), p = new w(this.ctx), f = u.getMarkerConfig("apexcharts-marker", h),
                            x = g.fillPath({
                                seriesNumber: s,
                                dataPointIndex: r,
                        ...
                        if (l.globals.dataChanged && "circle" === f.shape) if (this.dynamicAnim) {
                            ...
                            0 === t && 0 === e && (a = 0), c.animateCircle(n, {cx: k, cy: A, r: S}, {
                                cx: t,
                                cy: e,
                                r: a
                            }, L, l.globals.easing)
                ...
                return n(t, [{
                    ...
                    key: "drawDataLabel", value: function (t, e, i) {
                        var a = this, s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : 2,
                            r = this.w, o = new w(this.ctx), n = r.config.dataLabels, l = 0, h = 0, c = i, d = null;
                    ...
                    key: "plotDataLabelsText", value: function (t) {
                        var e = this.w, i = new w(this.ctx), a = t.x, s = t.y, r = t.i, o = t.j, n = t.text,
                            l = t.textAnchor, h = t.fontSize, c = t.parent, d = t.dataLabelsConfig, g = t.color,
                            u = t.alwaysDrawDataLabel, p = t.offsetCorrection;
                    ...
                    key: "addBackgroundToDataLabel", value: function (t, e) {
                        var i = this.w, a = i.config.dataLabels.background, s = a.padding, r = a.padding / 2,
                ...
                return n(t, [{
                    key: "handleBarDataLabels", value: function (t) {
                        var e = t.x, i = t.y, a = t.y1, s = t.y2, r = t.i, o = t.j, n = t.realIndex, l = t.series,
                            h = t.barHeight, c = t.barWidth, d = t.barYPosition, g = t.visibleSeries,
                            u = t.renderedPath, p = this.w, f = new w(this.barCtx.ctx),
                    ...
                    key: "calculateColumnsDataLabelsPosition", value: function (t) {
                        var e, i = this.w, a = t.i, s = t.j, r = t.y, o = t.bcx, n = t.barWidth, l = t.barHeight,
                            h = t.textRects, c = t.dataLabelsY, d = t.barDataLabelsConfig, g = t.strokeWidth,
                            u = t.offX, p = t.offY;
                        l = Math.abs(l);
                    ...
                    key: "calculateBarsDataLabelsPosition", value: function (t) {
                        var e = this.w, i = t.x, a = t.i, s = t.j, r = t.bcy, o = t.barHeight, n = t.barWidth,
                            l = t.textRects, h = t.dataLabelsX, c = t.strokeWidth, d = t.barDataLabelsConfig,
                            g = t.offX, u = t.offY, p = e.globals.gridHeight / e.globals.dataPoints;
                        n = Math.abs(n);
                    ...
                    key: "drawCalculatedDataLabels", value: function (t) {
                        var e = t.x, i = t.y, a = t.val, s = t.i, r = t.j, o = t.textRects, n = t.barHeight,
                            l = t.barWidth, h = t.dataLabelsConfig, d = this.w, g = "rotate(0)";
                        "vertical" === d.config.plotOptions.bar.dataLabels.orientation && (g = "rotate(-90, ".concat(e, ", ").concat(i, ")"));
                        var u = new E(this.barCtx.ctx), p = new w(this.barCtx.ctx), f = h.formatter, x = null,
                ...
                return n(t, [{
                    ...
                    key: "getActiveConfigSeriesIndex", value: function () {
                        var t = arguments.length > 0 && void 0 !== arguments[0] && arguments[0],
                            e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : "asc", i = this.w,
                            a = 0;
                    ...
                    key: "handleNoData", value: function () {
                        var t = this.w, e = t.config.noData, i = new w(this.ctx), a = t.globals.svgWidth / 2,
                ...
                return n(t, [{
                    ...
                    key: "getPathFillColor", value: function (t, e, i, a) {
                        var s = this.w, r = new z(this.barCtx.ctx), o = null,
                    ...
                    key: "barBackground", value: function (t) {
                        var e = t.j, i = t.i, a = t.x1, s = t.x2, r = t.y1, o = t.y2, n = t.elSeries, l = this.w,
                            h = new w(this.barCtx.ctx), c = new F(this.barCtx.ctx).getActiveConfigSeriesIndex();
                    ...
                    key: "getColumnPaths", value: function (t) {
                        var e = t.barWidth, i = t.barXPosition, a = t.yRatio, s = t.y1, r = t.y2, o = t.strokeWidth,
                            n = t.series, l = t.realIndex, h = t.i, c = t.j, d = t.w, g = new w(this.barCtx.ctx);
                        (o = Array.isArray(o) ? o[l] : o) || (o = 0);
                        var u = {barWidth: e, strokeWidth: o, yRatio: a, barXPosition: i, y1: s, y2: r},
                            p = this.getRoundedBars(d, u, n, h, c), f = i, x = i + e, b = g.move(f, s),
                            m = g.move(f, s), v = g.line(x - o, s);
                    ...
                    key: "getBarpaths", value: function (t) {
                        var e = t.barYPosition, i = t.barHeight, a = t.x1, s = t.x2, r = t.strokeWidth, o = t.series,
                            n = t.realIndex, l = t.i, h = t.j, c = t.w, d = new w(this.barCtx.ctx);
                    ...
                    key: "getRoundedBars", value: function (t, e, i, a, s) {
                        var r = new w(this.barCtx.ctx), o = 0, n = t.config.plotOptions.bar.borderRadius,
                            l = Array.isArray(n);
                    ...
                    key: "drawGoalLine", value: function (t) {
                        var e = t.barXPosition, i = t.barYPosition, a = t.goalX, s = t.goalY, r = t.barWidth,
                            o = t.barHeight, n = new w(this.barCtx.ctx),
                            l = n.group({className: "apexcharts-bar-goals-groups"}), h = null;
                ...
                return n(t, [{
                    key: "draw", value: function (t, e) {
                        ...
                        for (var o = 0, n = 0; o < t.length; o++, n++) {
                            var l, h, d, g, u = void 0, p = void 0, f = [], x = [],
                                b = i.globals.comboCharts ? e[o] : o, v = a.group({
                            ...
                            for (var C = a.group({
                                ...
                                var T = this.barHelpers.getStrokeWidth(o, P, b), M = null, z = {
                                    indexes: {i: o, j: P, realIndex: b, bc: n},
                                    x: u,
                                    y: p,
                                    strokeWidth: T,
                                    elSeries: v
                    ...
                    key: "renderSeries", value: function (t) {
                        var e = t.realIndex, i = t.pathFill, a = t.lineFill, s = t.j, r = t.i, o = t.pathFrom,
                            n = t.pathTo, l = t.strokeWidth, h = t.elSeries, c = t.x, d = t.y, g = t.y1, u = t.y2,
                            p = t.series, f = t.barHeight, x = t.barWidth, b = t.barYPosition, m = t.elDataLabelsWrap,
                            v = t.elGoalsMarkers, k = t.visibleSeries, A = t.type, S = this.w, C = new w(this.ctx);
                    ...
                    key: "drawBarPaths", value: function (t) {
                        var e = t.indexes, i = t.barHeight, a = t.strokeWidth, s = t.zeroW, r = t.x, o = t.y,
                            n = t.yDivision, l = t.elSeries, h = this.w, c = e.i, d = e.j;
                    ...
                    key: "drawColumnPaths", value: function (t) {
                        var e = t.indexes, i = t.x, a = t.y, s = t.xDivision, r = t.barWidth, o = t.zeroH,
                            n = t.strokeWidth, l = t.elSeries, h = this.w, c = e.realIndex, d = e.i, g = e.j, u = e.bc;
                ...
                return n(t, [{
                    ...
                    key: "formatDate", value: function (t, e) {
                        var i = this.w.globals.locale, a = this.w.config.xaxis.labels.datetimeUTC,
                            s = ["\0"].concat(x(i.months)), r = [""].concat(x(i.shortMonths)),
                            o = [""].concat(x(i.days)), n = [""].concat(x(i.shortDays));
                ...
                return n(i, [{
                    key: "draw", value: function (t, e) {
                        ...
                        for (var s = a.group({class: "apexcharts-rangebar-series apexcharts-plot-series"}), r = 0; r < t.length; r++) {
                            var o, n, l, h = void 0, d = void 0, g = void 0, u = i.globals.comboCharts ? e[r] : r,
                                p = a.group({
                                    class: "apexcharts-series",
                            ...
                            for (var v = a.group({
                                ...
                                var A = this.barHelpers.getStrokeWidth(r, k, u), S = this.seriesRangeStart[r][k],
                                    C = this.seriesRangeEnd[r][k], L = null, P = null,
                                    T = {x: h, y: d, strokeWidth: A, elSeries: p};
                                ...
                                var E = this.barHelpers.getPathFillColor(t, r, k, u), Y = i.globals.stroke.colors[u];
                                this.renderSeries({
                                    realIndex: u,
                                    pathFill: E,
                                    lineFill: Y,
                    ...
                    key: "drawRangeBarPaths", value: function (t) {
                        var e = t.indexes, i = t.y, a = t.y1, s = t.y2, r = t.yDivision, o = t.barHeight,
                            n = t.barYPosition, l = t.zeroW, h = this.w, c = l + a / this.invertedYRatio,
                            d = l + s / this.invertedYRatio, g = Math.abs(d - c), u = this.barHelpers.getBarpaths({
                                barYPosition: n,
                                barHeight: o,
                                x1: c,
                                x2: d,
                    ...
                    key: "getTooltipValues", value: function (t) {
                        var e = t.ctx, i = t.seriesIndex, a = t.dataPointIndex, s = t.y1, r = t.y2, o = t.w,
                            n = o.globals.seriesRangeStart[i][a], l = o.globals.seriesRangeEnd[i][a],
                            h = o.globals.labels[a], c = o.config.series[i].name ? o.config.series[i].name : "",
                            d = o.config.tooltip.y.formatter, g = o.config.tooltip.y.title.formatter,
                            ...
                            tooltip: {
                                shared: !1, followCursor: !0, custom: function (t) {
                                    return t.w.config.plotOptions && t.w.config.plotOptions.bar && t.w.config.plotOptions.bar.horizontal ? function (t) {
                                        var e = new N(t.ctx, null), i = e.getTooltipValues(t), a = i.color,
                                            s = i.seriesName, r = i.ylabel, o = i.startVal, n = i.endVal;
                                        ...
                                        var e = new N(t.ctx, null), i = e.getTooltipValues(t), a = i.color,
                                            s = i.seriesName, r = i.ylabel, o = i.start, n = i.end;
                                        return e.buildCustomTooltipHTML({
                                            color: a,
                                            seriesName: s,
                                            ylabel: r,
                ...
                return n(t, [{
                    key: "init", value: function (t) {
                        var e = t.responsiveOverride, i = this.opts, a = new T, r = new O(i);
                ...
                return n(t, [{
                    key: "init", value: function () {
                        ...
                        return {config: t, globals: (new B).init(t)}
                    }
                }]), t
            }(), G = function () {
                function t(e) {
                ...
                return n(t, [{
                    ...
                    key: "handleRangeDataFormat", value: function (t, e, i) {
                        ...
                        if ("array" === t) {
                            ...
                            for (var h = function (t) {
                                var o = m.randomId(), n = e[i].data[t].x,
                    ...
                    key: "handleCandleStickBoxDataFormat", value: function (t, e, i) {
                        var a = this.w, s = "boxPlot" === a.config.chart.type || "boxPlot" === a.config.series[i].type,
                            r = [], o = [], n = [], l = [], h = [];
                    ...
                    key: "parseDataAxisCharts", value: function (t) {
                        var e = this, i = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : this.ctx,
                            a = this.w.config, s = this.w.globals, r = new D(i),
                ...
                return n(t, [{
                    key: "getLabel", value: function (t, e, i, a) {
                        var s = arguments.length > 4 && void 0 !== arguments[4] ? arguments[4] : [],
                            ...
                            n = void 0 === t[a] ? "" : t[a], l = n, h = o.globals.xLabelFormatter,
                            c = o.config.xaxis.labels.formatter, d = !1, g = new _(this.ctx), u = n;
                        l = g.xLabelFormat(h, n, u, {
                            i: a,
                            dateFormatter: new D(this.ctx).formatDate,
                            w: o
                        }), void 0 !== c && (l = c(n, t[a], {i: a, dateFormatter: new D(this.ctx).formatDate, w: o}));
                        var p = function (t) {
                            var i = null;
                ...
                return n(t, [{
                    ...
                    key: "exportToCSV", value: function (t) {
                        var e = this, i = t.series, a = t.columnDelimiter, s = t.lineDelimiter,
                            r = void 0 === s ? "\n" : s, o = this.w, n = [], l = [],
                            h = "data:text/csv;charset=utf-8,\ufeff", c = new G(this.ctx), d = new j(this.ctx),
                            g = function (t) {
                                var i = "";
                ...
                return n(t, [{
                    key: "drawXaxis", value: function () {
                        var t, e = this, i = this.w, a = new w(this.ctx), s = a.group({
                        ...
                        if (void 0 !== i.config.xaxis.title.text) {
                            var u = a.group({class: "apexcharts-xaxis-title"}), p = a.drawText({
                    ...
                    key: "drawXaxisInversed", value: function (t) {
                        var e, i, a = this, s = this.w, r = new w(this.ctx),
                ...
                return n(t, [{
                    ...
                    key: "_drawGridLine", value: function (t) {
                        var e = t.x1, i = t.y1, a = t.x2, s = t.y2, r = t.parent, o = this.w,
                            ...
                            l = o.config.grid.strokeDashArray, h = o.globals.barPadForNumericAxis,
                    ...
                    key: "_drawGridBandRect", value: function (t) {
                        var e = t.c, i = t.x1, a = t.y1, s = t.x2, r = t.y2, o = t.type, n = this.w,
                            l = new w(this.ctx), h = n.globals.barPadForNumericAxis;
                ...
                return n(t, [{
                    ...
                    key: "setYScaleForIndex", value: function (t, e, i) {
                        ...
                        var o = Math.abs(i - e);
                        if (r.logarithmic && o <= 5 && (a.invalidLogScale = !0), r.logarithmic && o > 5) a.allSeriesCollapsed = !1, a.yAxisScale[t] = this.logarithmicScale(i); else if (i !== -Number.MAX_VALUE && m.isNumber(i)) if (a.allSeriesCollapsed = !1, void 0 === r.min && void 0 === r.max || r.forceNiceScale) {
                    ...
                    key: "autoScaleY", value: function (t, e, i) {
                        ...
                        return e.forEach((function (t, o) {
                            ...
                            var h, c, d = a.globals.minYArr[o], g = a.globals.maxYArr[o],
                ...
                return n(t, [{
                    ...
                    key: "getMinYMaxY", value: function (t) {
                        var e = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : Number.MAX_VALUE,
                            ...
                            s = this.w.config, r = this.w.globals, o = -Number.MAX_VALUE, n = Number.MIN_VALUE;
                        null === a && (a = t + 1);
                    ...
                    key: "_setStackedMinMax", value: function () {
                        ...
                        if (t.series.length) for (var a = 0; a < t.series[t.maxValsInArrayIndex].length; a++) for (var s = 0, r = 0, o = 0; o < t.series.length; o++) null !== t.series[o][a] && m.isNumber(t.series[o][a]) && (t.series[o][a] > 0 ? s = s + parseFloat(t.series[o][a]) + 1e-4 : r += parseFloat(t.series[o][a])), o === t.series.length - 1 && (e.push(s), i.push(r));
                ...
                return n(t, [{
                    key: "drawYaxis", value: function (t) {
                        var e = this, i = this.w, a = new w(this.ctx), s = i.config.yaxis[t].labels.style,
                            r = s.fontSize, o = s.fontFamily, n = s.fontWeight, l = a.group({
                    ...
                    key: "yAxisTitleRotate", value: function (t, e) {
                        var i = this.w, a = new w(this.ctx), s = {width: 0, height: 0}, r = {width: 0, height: 0},
                ...
                return n(t, [{
                    key: "drawXCrosshairs", value: function () {
                        var t = this.w, e = new w(this.ctx), i = new y(this.ctx),
                            a = t.config.xaxis.crosshairs.fill.gradient, s = t.config.xaxis.crosshairs.dropShadow,
                            r = t.config.xaxis.crosshairs.fill.type, o = a.colorFrom, n = a.colorTo, l = a.opacityFrom,
                            h = a.opacityTo, c = a.stops, d = s.enabled, g = s.left, u = s.top, p = s.blur, f = s.color,
                            x = s.opacity, b = t.config.xaxis.crosshairs.fill.color;
                    ...
                    key: "drawYCrosshairs", value: function () {
                        var t = this.w, e = new w(this.ctx), i = t.config.yaxis[0].crosshairs,
                    ...
                    key: "checkResponsiveConfig", value: function (t) {
                        ...
                        if (0 !== a.responsive.length) {
                            ...
                            var r = new W({}), o = function () {
                                ...
                                } else for (var l = 0; l < s.length; l++) o < s[l].breakpoint && (t = S.extendArrayProps(r, s[l].options, i), t = m.extend(i.config, t), e.overrideResponsiveOptions(t))
                            };
                            if (t) {
                ...
                return n(t, [{
                    key: "getxAxisLabelsCoords", value: function () {
                        ...
                        if (e.config.xaxis.convertedCatToNumeric && 0 === i.length && (i = e.globals.categoryLabels), e.globals.timescaleLabels.length > 0) {
                            ...
                            var s = e.globals.xLabelFormatter, r = m.getLargestStringFromArr(i),
                            ...
                            var h = new w(this.dCtx.ctx), c = h.getTextRects(r, e.config.xaxis.labels.style.fontSize),
                                d = c;
                ...
                return n(t, [{
                    key: "getyAxisLabelsCoords", value: function () {
                        ...
                        return e.config.yaxis.map((function (r, o) {
                            ...
                            if (!s.isYAxisHidden(o) && r.labels.show && void 0 !== r.labels.minWidth && (l = r.labels.minWidth), !s.isYAxisHidden(o) && r.labels.show && n.result.length) {
                                ...
                                var f = new w(t.dCtx.ctx), x = "rotate(".concat(r.labels.rotate, " 0 0)"),
                    ...
                    key: "getyAxisTitleCoords", value: function () {
                        ...
                        return e.config.yaxis.map((function (e, a) {
                            if (e.show && void 0 !== e.title.text) {
                                var s = new w(t.dCtx.ctx), r = "rotate(".concat(e.title.rotate, " 0 0)"),
                    ...
                    key: "getTotalYAxisWidth", value: function () {
                        var t = this.w, e = 0, i = 0, a = 0, s = t.globals.yAxisScale.length > 1 ? 10 : 0,
                            r = new j(this.dCtx.ctx), o = function (o, n) {
                ...
                return n(t, [{
                    ...
                    key: "drawLegends", value: function () {
                        ...
                        for (var o = e.globals.legendFormatter, n = e.config.legend.inverseOrder, l = n ? a.length - 1 : 0; n ? l >= 0 : l <= a.length - 1; n ? l-- : l++) {
                            ...
                            var f = e.config.legend.markers.offsetX, x = e.config.legend.markers.offsetY,
                                b = e.config.legend.markers.height, v = e.config.legend.markers.width,
                                y = e.config.legend.markers.strokeWidth, k = e.config.legend.markers.strokeColor,
                                A = e.config.legend.markers.radius, C = p.style;
                    ...
                    key: "setLegendWrapXY", value: function (t, e) {
                        ...
                        if ("bottom" === i.config.legend.position) o += i.globals.svgHeight - s.height / 2; else if ("top" === i.config.legend.position) {
                            var n = new ct(this.ctx), l = n.dimHelpers.getTitleSubtitleCoords("title").height,
                    ...
                    key: "legendAlignHorizontal", value: function () {
                        ...
                        var e = this.legendHelpers.getLegendBBox(), i = new ct(this.ctx),
                ...
                return n(i, [{
                    ...
                    key: "drawSelectionRect", value: function (t) {
                        var e = t.x, i = t.y, a = t.width, s = t.height, r = t.translateX, o = void 0 === r ? 0 : r,
                            n = t.translateY, l = void 0 === n ? 0 : n, h = this.w, c = this.zoomRect,
                    ...
                    key: "selectionDrawing", value: function (t) {
                        var e, i = t.context, a = t.zoomtype, s = this.w, r = i,
                            o = this.gridRect.getBoundingClientRect(), n = r.startX - 1, l = r.startY, h = !1, c = !1,
                            d = r.clientX - o.left - n, g = r.clientY - o.top - l;
                    ...
                    key: "delayedPanScrolled", value: function () {
                        var t = this.w, e = t.globals.minX, i = t.globals.maxX,
                    ...
                    key: "panScrolled", value: function (t, e) {
                        var i = this.w, a = this.xyRatios, s = m.clone(i.globals.initialConfig.yaxis), r = a.xRatio,
                ...
                return n(t, [{
                    key: "getNearestValues", value: function (t) {
                        var e = t.hoverArea, i = t.elGrid, a = t.clientX, s = t.clientY, r = this.w,
                            o = r.globals.gridWidth, n = r.globals.gridHeight, l = o / (r.globals.dataPoints - 1),
                            h = n / r.globals.dataPoints, c = i.getBoundingClientRect(), d = this.hasBars();
                ...
                return n(t, [{
                    key: "drawSeriesTexts", value: function (t) {
                        var e = t.shared, i = void 0 === e || e, a = t.ttItems, s = t.i, r = void 0 === s ? 0 : s,
                            o = t.j, n = void 0 === o ? null : o, l = t.y1, h = t.y2, c = t.e, d = this.w;
                    ...
                    key: "printLabels", value: function (t) {
                        var e, i = this, a = t.i, s = t.j, r = t.values, o = t.ttItems, n = t.shared, l = t.e,
                            h = this.w, d = [], g = function (t) {
                        ...
                        for (var m = function (t, r) {
                            ...
                            null === s && (e = m.yLbFormatter(h.globals.series[a], c(c({}, h), {}, {
                                ...
                                j: s,
                                ttItems: o,
                                values: {val: e, goalVals: d, xVal: u, xAxisTTVal: f, zVal: p},
                                seriesName: x,
                                shared: n,
                                pColor: b
                            })
                    ...
                    key: "DOMHandling", value: function (t) {
                        ...
                        var e = t.t, i = t.j, a = t.ttItems, s = t.values, r = t.seriesName, o = t.shared, n = t.pColor,
                            l = this.w, h = this.ttCtx, c = s.val, d = s.goalVals, g = s.xVal, u = s.xAxisTTVal,
                            p = s.zVal, f = null;
                    ...
                    key: "getValuesToPrint", value: function (t) {
                        var e = t.i, i = t.j, a = this.w, s = this.ctx.series.filteredSeriesX(), r = "", o = "",
                            n = null, l = null, h = {series: a.globals.series, seriesIndex: e, dataPointIndex: i, w: a},
                ...
                return n(t, [{
                    ...
                    key: "moveYCrosshairs", value: function (t) {
                        ...
                        null !== e.ycrosshairs && w.setAttrs(e.ycrosshairs, {
                            y1: t,
                            y2: t
                        }), null !== e.ycrosshairsHidden && w.setAttrs(e.ycrosshairsHidden, {y1: t, y2: t})
                    }
                }, {
                ...
                return n(t, [{
                    key: "drawDynamicPoints", value: function () {
                        var t = this.w, e = new w(this.ctx), i = new I(this.ctx),
                ...
                return n(t, [{
                    ...
                    key: "handleBarTooltip", value: function (t) {
                        var e, i, a = t.e, s = t.opt, r = this.w, o = this.ttCtx, n = o.getElTooltip(), l = 0, h = 0,
                            c = 0, d = this.getBarTooltipXY({e: a, opt: s});
                        e = d.i;
                    ...
                    key: "getBarTooltipXY", value: function (t) {
                        ...
                        if (d.contains("apexcharts-bar-area") || d.contains("apexcharts-candlestick-area") || d.contains("apexcharts-boxPlot-area") || d.contains("apexcharts-rangebar-area")) {
                            var g = e.target, u = g.getBoundingClientRect(), p = i.elGrid.getBoundingClientRect(),
                                f = u.height;
                            c = u.height;
                            var x = u.width, b = parseInt(g.getAttribute("cx"), 10),
                ...
                return n(t, [{
                    ...
                    key: "create", value: function (t, e, i, a, s) {
                        var r = arguments.length > 5 && void 0 !== arguments[5] ? arguments[5] : null, o = this.w,
                            n = e;
                ...
                return n(i, [{
                    key: "draw", value: function (t, e) {
                        ...
                        for (var o = this.graphics.group({class: "apexcharts-bar-series apexcharts-plot-series"}), n = 0, l = 0, h = function (s, r) {
                            var h = void 0, d = void 0, g = void 0, u = void 0, p = [], f = [],
                            ...
                            var v = i.graphics.group({class: "apexcharts-datalabels", "data:realIndex": x}), y = 0,
                                w = 0, k = i.initialPositions(n, l, h, d, g, u);
                            ...
                            for (var A = 0; A < a.globals.dataPoints; A++) {
                                var S = i.barHelpers.getStrokeWidth(s, A, x), C = {
                                    indexes: {i: s, j: A, realIndex: x, bc: r},
                                    strokeWidth: S,
                                    x: n,
                                    y: l,
                                    elSeries: b
                ...
                return n(i, [{
                    key: "draw", value: function (t, e) {
                        ...
                        for (var n = s.group({class: "apexcharts-".concat(a.config.chart.type, "-series apexcharts-plot-series")}), l = function (o) {
                            ...
                            var l, h, c, d, g = void 0, u = void 0, p = [], f = [],
                                x = a.globals.comboCharts ? e[o] : o, b = s.group({
                                    class: "apexcharts-series",
                                    seriesName: m.escapeString(a.globals.seriesNames[x]),
                                    rel: o + 1,
                                    "data:realIndex": x
                            ...
                            for (var y = s.group({
                                ...
                                var s = i.barHelpers.getStrokeWidth(o, e, x), n = i.drawBoxPaths({
                                    indexes: {i: o, j: e, realIndex: x},
                                    x: g,
                                    y: u,
                                    xDivision: l,
                                    barWidth: d,
                    ...
                    key: "drawBoxPaths", value: function (t) {
                        var e = t.indexes, i = t.x;
                        t.y;
                        var a = t.xDivision, s = t.barWidth, r = t.zeroH, o = t.strokeWidth, n = this.w,
                            l = new w(this.ctx), h = e.i, c = e.j, d = !0,
                        ...
                        var f = this.yRatio[this.yaxisIndex], x = e.realIndex, b = this.getOHLCValue(x, c), m = r,
                            v = r;
                        b.o > b.c && (d = !1);
                ...
                return n(t, [{
                    ...
                    key: "getShadeColor", value: function (t, e, i, a) {
                        var s = this.w, r = 1, o = s.config.plotOptions[t].shadeIntensity,
                    ...
                    key: "determineColor", value: function (t, e, i) {
                        ...
                        var n = a.globals.colors[o], l = null, h = Math.min.apply(Math, x(a.globals.series[e])),
                    ...
                    key: "calculateDataLabels", value: function (t) {
                        var e = t.text, i = t.x, a = t.y, s = t.i, r = t.j, o = t.colorProps, n = t.fontSize,
                            l = this.w.config.dataLabels, h = new w(this.ctx), c = new E(this.ctx), d = null;
                        if (l.enabled) {
                ...
                return n(t, [{
                    key: "draw", value: function (t) {
                        ...
                        var s = e.globals.gridWidth / e.globals.dataPoints,
                            r = e.globals.gridHeight / e.globals.series.length, o = 0, n = !1;
                ...
                return n(t, [{
                    key: "draw", value: function (t) {
                        ...
                        var p = i.config.plotOptions.pie.customScale, f = i.globals.gridWidth / 2,
                            x = i.globals.gridHeight / 2, b = f - i.globals.gridWidth / 2 * p,
                        ...
                        if (this.sliceLabels.forEach((function (t) {
                            k.add(t)
                        })), n.attr({transform: "translate(".concat(b, ", ").concat(v, ") scale(").concat(p, ")")}), n.add(k), this.ret.add(n), this.donutDataLabels.show) {
                    ...
                    key: "drawArcs", value: function (t, e) {
                        var i = this.w, a = new y(this.ctx), s = new w(this.ctx), r = new z(this.ctx),
                            ...
                            if (!this.initialAnim || i.globals.resized || i.globals.dataChanged ? this.animBeginArr.push(0) : (0 == (k = u / this.fullAngle * i.config.chart.animations.speed) && (k = 1), this.animDur = k + this.animDur, this.animBeginArr.push(this.animDur)), this.dynamicAnim && i.globals.dataChanged ? this.animatePaths(x, {
                                ...
                                if (0 !== u && i.config.plotOptions.pie.dataLabels.minAngleToShowLabel < t[d]) {
                                    ...
                                    var P = i.globals.dataLabels.style.colors[d],
                                        T = s.group({class: "apexcharts-datalabels"}), M = s.drawText({
                                            x: A,
                                            y: S,
                                            text: C,
                                            textAnchor: "middle",
                    ...
                    key: "getPiePath", value: function (t) {
                        var e = t.me, i = t.startAngle, a = t.angle, s = t.size, r = i, o = Math.PI * (r - 90) / 180,
                            n = a + i;
                        ...
                        var l = Math.PI * (n - 90) / 180, h = e.centerX + s * Math.cos(o),
                            c = e.centerY + s * Math.sin(o), d = e.centerX + s * Math.cos(l),
                            g = e.centerY + s * Math.sin(l),
                            u = m.polarToCartesian(e.centerX, e.centerY, e.donutSize, n),
                            p = m.polarToCartesian(e.centerX, e.centerY, e.donutSize, r), f = a > 180 ? 1 : 0,
                    ...
                    key: "drawPolarElements", value: function (t) {
                        var e = this.w, i = new $(this.ctx), a = new w(this.ctx), s = new Lt(this.ctx), r = a.group(),
                            o = a.group(),
                    ...
                    key: "renderInnerDataLabels", value: function (t, e) {
                        var i = this.w, a = new w(this.ctx), s = a.group({
                        ...
                        if (t.value.show) {
                            var b = t.name.show ? parseFloat(t.value.offsetY) + 16 : t.value.offsetY, m = a.drawText({
                                x: l,
                                y: h + b,
                                text: p,
                                textAnchor: "middle",
                    ...
                    key: "revertDataLabelsInner", value: function (t, e, i) {
                        var a = this, s = this.w,
                            r = s.globals.dom.baseEl.querySelector(".apexcharts-datalabels-group"), o = !1,
                ...
                return n(t, [{
                    key: "draw", value: function (t) {
                        ...
                        var o = i.globals.gridWidth / 2, n = i.globals.gridHeight / 2,
                            l = o + i.config.plotOptions.radar.offsetX, h = n + i.config.plotOptions.radar.offsetY,
                        ...
                        if (this.yaxisLabels = this.graphics.group({class: "apexcharts-yaxis"}), t.forEach((function (t, o) {
                            ...
                            for (var x = 0; x < h.linePathsTo.length; x++) {
                                ...
                                l.add(b);
                                var v = a.fillPath({seriesNumber: o}), w = e.graphics.renderPaths(c(c({}, d), {}, {
                        ...
                        return e.globals.labels.forEach((function (r, o) {
                            ...
                            if (s[o]) {
                                ...
                                l.plotDataLabelsText({
                                    ...
                                    dataLabelsConfig: c({textAnchor: h.textAnchor, dropShadow: {enabled: !1}}, i),
                                    offsetCorrection: !1
                                })
                            }
                        })), a
                ...
                return n(i, [{
                    key: "draw", value: function (t) {
                        ...
                        var s = i.group(), r = this.defaultSize / 2, o = e.globals.gridWidth / 2,
                    ...
                    key: "drawTracks", value: function (t) {
                        var e = this.w, i = new w(this.ctx), a = i.group({class: "apexcharts-tracks"}),
                            s = new y(this.ctx), r = new z(this.ctx), o = this.getStrokeWidth(t);
                        t.size = t.size - o / 2;
                    ...
                    key: "drawArcs", value: function (t) {
                        var e = this.w, i = new w(this.ctx), a = new z(this.ctx), s = new y(this.ctx), r = i.group(),
                    ...
                    key: "drawHollowImage", value: function (t, e, i, a) {
                        var s = this.w, r = new z(this.ctx), o = m.randomId(),
                ...
                return n(t, [{
                    ...
                    key: "calculatePoints", value: function (t) {
                        var e = t.series, i = t.realIndex, a = t.x, s = t.y, r = t.i, o = t.j, n = t.prevY, l = this.w,
                            h = [], c = [];
                        if (0 === o) {
                ...
                return n(t, [{
                    key: "draw", value: function (t, e, i) {
                        var a = this.w, s = new w(this.ctx), r = a.globals.comboCharts ? e : a.config.chart.type,
                        ...
                        if (a.config.chart.stacked) for (var y = l.length; y > 0; y--) o.add(l[y - 1]); else for (var k = 0; k < l.length; k++) o.add(l[k]);
                        return o
                    }
                }, {
                    ...
                    key: "_handlePaths", value: function (t) {
                        var e = t.type, i = t.realIndex, a = t.i, s = t.paths, r = this.w, o = new w(this.ctx),
                            n = new z(this.ctx);
                        ...
                        if ("area" === e) for (var p = n.fillPath({seriesNumber: i}), f = 0; f < s.areaPaths.length; f++) {
                        ...
                        if (r.config.stroke.show && !this.pointsChart) {
                            var b;
                            b = "line" === e ? n.fillPath({seriesNumber: i, i: a}) : r.globals.stroke.colors[i];
                    ...
                    key: "_handleMarkersAndLabels", value: function (t) {
                        ...
                        var i = t.i, a = t.j, s = t.realIndex, r = this.w, o = new E(this.ctx);
                    ...
                    key: "_createPaths", value: function (t) {
                        var e = t.series, i = t.i, a = t.realIndex, s = t.j, r = t.x, o = t.y, n = t.pX, l = t.pY,
                            h = t.linePath, c = t.areaPath, d = t.linePaths, g = t.areaPaths, u = t.seriesIndex,
                            p = this.w, f = new w(this.ctx), x = p.config.stroke.curve, b = this.areaBottomY;
            ...
            window.TreemapSquared = {}, window.TreemapSquared.generate = function () {
                function t(e, i, a, s) {
                    this.xoffset = e, this.yoffset = i, this.height = s, this.width = a, this.shortestEdge = function () {
                        ...
                        var e, i = [], a = this.xoffset, s = this.yoffset, o = r(t) / this.height,
                            n = r(t) / this.width;
            ...
            var Xt, Et, Yt = function () {
                ...
                return n(t, [{
                    key: "draw", value: function (t) {
                        var e = this, i = this.w, a = new w(this.ctx), s = new z(this.ctx),
                ...
                return n(t, [{
                    key: "calculateTimeScaleTicks", value: function (t, e) {
                        ...
                        var o = s.getTimeUnitsfromTimestamp(t, e, this.utc), n = a.globals.gridWidth / r, l = n / 24,
                            h = l / 60, d = h / 60, g = Math.floor(24 * r), u = Math.floor(1440 * r),
                            p = Math.floor(86400 * r), f = Math.floor(r), x = Math.floor(r / 30),
                        ...
                        var y = this.timeScaleArray.map((function (t) {
                            ...
                            return "month" === t.unit ? c(c({}, e), {}, {
                                day: 1,
                                value: t.value + 1
                            }) : "day" === t.unit || "hour" === t.unit ? c(c({}, e), {}, {value: t.value}) : "minute" === t.unit ? c(c({}, e), {}, {
                                value: t.value,
                                minute: t.value
                            }) : "second" === t.unit ? c(c({}, e), {}, {
                                value: t.value,
                    ...
                    key: "generateYearScale", value: function (t) {
                        var e = t.firstVal, i = t.currentMonth, a = t.currentYear, s = t.daysWidthOnXAxis,
                            r = t.numberOfYears, o = e.minYear, n = 0, l = new D(this.ctx), h = "year";
                    ...
                    key: "generateMonthScale", value: function (t) {
                        var e = t.firstVal, i = t.currentMonthDate, a = t.currentMonth, s = t.currentYear,
                            r = t.daysWidthOnXAxis, o = t.numberOfMonths, n = a, l = 0, h = new D(this.ctx),
                            c = "month", d = 0;
                        if (e.minDate > 1) {
                    ...
                    key: "generateDayScale", value: function (t) {
                        var e = t.firstVal, i = t.currentMonth, a = t.currentYear, s = t.hoursWidthOnXAxis,
                            r = t.numberOfDays, o = new D(this.ctx), n = "day", l = e.minDate + 1, h = l,
                            c = function (t, e, i) {
                    ...
                    key: "generateHourScale", value: function (t) {
                        var e = t.firstVal, i = t.currentDate, a = t.currentMonth, s = t.currentYear,
                            r = t.minutesWidthOnXAxis, o = t.numberOfHours, n = new D(this.ctx), l = "hour",
                            h = function (t, e) {
                ...
                return n(t, [{
                    ...
                    key: "plotChartType", value: function (t, e) {
                        var i = this.w, a = i.config, s = i.globals, r = {series: [], i: []}, o = {series: [], i: []},
                            n = {series: [], i: []}, l = {series: [], i: []}, h = {series: [], i: []},
                            c = {series: [], i: []}, d = {series: [], i: []};
                ...
                return n(t, [{
                    key: "_updateOptions", value: function (t) {
                        var e = this, i = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                            ...
                            o = arguments.length > 4 && void 0 !== arguments[4] && arguments[4], n = [this.ctx];
                    ...
                    key: "_updateSeries", value: function (t, e) {
                        var i, a = this, s = arguments.length > 2 && void 0 !== arguments[2] && arguments[2],
                            r = this.w;
                        ...
                        }))).length && (i = [{data: []}]), r.config.series = i) : r.config.series = t.slice(), s && (r.globals.initialSeries = m.clone(r.config.series)), this.ctx.update()
                    }
                }, {
            ...
            Xt = "undefined" != typeof window ? window : void 0, Et = function (t, e) {
                ...
                i.PathArray = function (t, e) {
                    ...
                    var o = a.bind(s || t.instance || t), n = (i.handlerMap.indexOf(t) + 1 || i.handlerMap.push(t)) - 1,
            ...
            }.call(e, i, e, t)) && (t.exports = a), function () {
                ...
                function a(t) {
                    ...
                    switch (t[0]) {
                        ...
                        case"A":
                            t = (e = function (t, e) {
                                var i, a, s, r, o, n, l, h, c, d, g, u, p, f, x, b, m, v, y, w, k, A, S, C, L, P,
                                    T = Math.abs(e[1]), M = Math.abs(e[2]), z = e[3] % 360, I = e[4], X = e[5],
                                    E = e[6], Y = e[7], F = new SVG.Point(t), R = new SVG.Point(E, Y), H = [];
                ...
                var i, a,
                    ...
                    r = (a = window.cancelAnimationFrame || window.mozCancelAnimationFrame || window.webkitCancelAnimationFrame || window.clearTimeout, function (t) {
                        return a(t)
                    }), o = !1, n = "animationstart", l = "Webkit Moz O ms".split(" "),
            ...
            var Dt = function () {
                ...
                return n(t, [{
                    ...
                    key: "getChartByID", value: function (t) {
                        var e = m.escapeString(t), i = Apex._chartInstances.filter((function (t) {
                            return t.id === e
                        }))[0];
                        return i && i.chart
                    }
    ...
    (() => {
        ...
        $((function () {
            ...
            new n(document.querySelector("#bar"), {
                ...
                plotOptions: {bar: {dataLabels: {enabled: !1}, columnWidth: "42%", endingShape: "rounded"}},
                dataLabels: {enabled: !1},
                stroke: {show: !0, width: 2, endingShape: "rounded", colors: ["transparent"]},
                responsive: [{
                    enable: "true",
                    breakpoint: 576,
                    options: {stroke: {show: !0, width: 1, endingShape: "rounded", colors: ["transparent"]}}
                }],
                series: [{
                    name: "Impressions",
                ...
                }, {name: "در حال پیش رفت", data: [26, 35, 41, 78, 34, 65, 27, 46, 37, 65, 49, 23, 49]}],
                xaxis: {categories: ["مرداد", "تیر", "خرداد", "فروردین", "اسفند", "بهمن", "دی", "آذر", "آبان", "مهر"]},
                fill: {opacity: 1},
                legend: {show: !1, floating: !0, position: "top", horizontalAlign: "left"},
                tooltip: {
                    y: {
                        formatter: function (t) {
                            return "ت" + t + " هزاران نفر"
                        }
                    }
                }
            }).render();
            var l = (t(e = {
                ...
                series: [{data: [12, 25, 76, 35, 17, 43, 10, 26, 69, 31]}],
                stroke: {curve: "smooth"},
                markers: {size: 0},
                grid: {padding: {top: 10, bottom: 10, left: 50}},
                colors: ["#673ab7"],
                xaxis: {crosshairs: {width: 1}}
            }, "stroke", {width: 2}), t(o, "tooltip", {
                x: {show: !1}, y: {
                    title: {
                        formatter: function (t) {
                            return ""
            ...
            var u = {
                ...
                plotOptions: {
                    radialBar: {
                        ...
                        imageWidth: 50,
                        imageHeight: 50,
                        track: {strokeWidth: "80%", background: "#ecf0fa"},
                        dropShadow: {enabled: !1, top: 0, left: 0, bottom: 0, blur: 3, opacity: .5},
                        dataLabels: {
                            name: {fontSize: "16px", color: void 0, offsetY: 30},
                            hollow: {size: "60%"},
                            value: {
                                offsetY: -10, fontSize: "22px", color: void 0, formatter: function (t) {
                                    return t + "%"
                                }
                            }
                        }
