                        ...
                        <div class="table-responsive">
                            <table class="table table-striped mg-b-0 text-md-nowrap">
                                ...
                                <tr>
                                    ...
                                    <td> {{ jalaliDate($post->published_at) ?? '-' }} {{ jalaliDate($post->published_at) }} </td>
                                </tr>
                                <tr>
                                    <th class="font-weight-bold">زمان ایجاده شده :</th>
                                    <td>{{ jalaliDate($post->created_at) }} {{ jalaliDate($post->created_at) }}</td>
                                </tr>
                                <tr>
                                    <th class="font-weight-bold">ویرایش شده در :</th>
                                    <td>{{ jalaliDate($post->updated_at) }} {{ jalaliDate($post->updated_at) }}</td>
                                </tr>
                                <tr>
