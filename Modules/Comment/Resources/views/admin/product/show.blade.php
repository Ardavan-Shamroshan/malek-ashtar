...
@section('title')
    نمایش نظر محصولات | داشبورد مدیریت
@endsection
@section('content')
    <!-- breadcrumb -->
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('admin.product.comment') }}">نظر محصولات</a></li>
                ...
                <div class="d-flex justify-content-between">
                    <div class="d-flex gap-2">
                        ...
                        <p class="tx-12 tx-gray-500 mb-2">نمایش نظر.
                            <a href="{{ route('admin.product.comment') }}" id="m-l-c-05"><i class="fe fe-chevrons-right  "></i>بازگشت به لیست نظر ها</a>
                        </p>
                    </div>

                    <div>
                        <div class="tag tag-rounded tag-blue">
                            <a href="{{ route('product.show', $comment->commentable) }}" class="text-white"><i class="fe fe-chevron-right"></i> مشاهده در وبگاه</a>
                        </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped mg-b-0 text-md-nowrap">
                                    ...
                                    <td>
                                        ...
                                        @if($comment->parent)
                                            ...
                                            <div>
                                                ...
                                                <small><a href="{{ route('admin.product.comment.show', $comment->parent) }}">{{ $comment->parent->body ?? '-' }}</a></small>
                                            </div>
                                        @endif
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{ route('admin.user') }}">{{ $comment->author->fullname ?? $comment->author->name ?? '-' }}</a></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <th class="font-weight-bold">محصول / کد محصول / دسته بندی :</th>
                                    <td>
                                        <a href="{{ route('admin.product.show', $comment->commentable) }}" class="tx-12">{{ $comment->commentable->name ?? '-' }}</a>:
                                ...
                                <tr>
                                    ...
                                    <td>{{ jalaliDate($comment->created_at) }} {{ jalaliDate($comment->created_at, 'H:i') }}</td>
                                </tr>
                                <tr>
                                    <th class="font-weight-bold">ویرایش شده در :</th>
                                    <td>{{ jalaliDate($comment->updated_at) }} {{ jalaliDate($comment->updated_at, 'H:i') }}</td>
                                </tr>
                                <tr>
