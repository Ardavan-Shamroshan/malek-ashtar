                        ...
                        <div class="table-responsive">
                            <table class="table table-striped mg-b-0 text-md-nowrap">
                                ...
                                <tr>
                                    ...
                                    <td>{{ jalaliDate($postcategory->created_at) }} {{ jalaliDate($postcategory->created_at) }}</td>
                                </tr>
                                <tr>
                                    <th class="font-weight-bold">ویرایش شده در :</th>
                                    <td>{{ jalaliDate($postcategory->updated_at) }} {{ jalaliDate($postcategory->updated_at) }}</td>
                                </tr>
                                <tr>
