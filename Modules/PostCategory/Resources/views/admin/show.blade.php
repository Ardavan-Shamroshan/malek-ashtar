                        ...
                        <div class="table-responsive">
                            <table class="table table-striped mg-b-0 text-md-nowrap">
                                ...
                                <tr>
                                    ...
                                    <td><a href="" class="btn-sm">{{ $postcategory->posts->count() }} مورد</a></td>
                                </tr>
                                <tr>
                                    <th class="font-weight-bold">زمان ایجاده شده :</th>
                                    <td>{{ jalaliDate($postcategory->created_at) }} {{ jalaliDate($postcategory->created_at, 'H:i') }}</td>
                                </tr>
                                <tr>
                                    <th class="font-weight-bold">ویرایش شده در :</th>
                                    <td>{{ jalaliDate($postcategory->updated_at) }} {{ jalaliDate($postcategory->updated_at, 'H:i') }}</td>
                                </tr>
                                <tr>
