                                                                    ...
                                                                    <div class="d-flex">
                                                                        <ul class="list-unstyled w-100">
                                                                            ...
                                                                            <li class="d-flex justify-content-start gap-3 m-0 p-3">
                                                                                ...
                                                                                {{ jalaliDate($post->published_at) ?? '-' }} {{ jalaliDate($post->published_at, 'H:i') }}

                                                                            </li>
                                                                            <li class="d-flex justify-content-start gap-3 bg-light m-0 p-3">
                                                                                <div class="font-weight-bold">زمان ایجاده شده :</div>
                                                                                <div>{{ jalaliDate($post->created_at) }} {{ jalaliDate($post->created_at, 'H:i') }}</div>

                                                                            </li>
                                                                            <li class="d-flex justify-content-start gap-3 m-0 p-3">
                                                                                <div class="font-weight-bold">ویرایش شده در :</div>
                                                                                <div>{{ jalaliDate($post->updated_at) }} {{ jalaliDate($post->updated_at, 'H:i') }}</div>
                                                                            </li>
                                                                            <li class="d-flex justify-content-start gap-3 bg-light m-0 p-3">
