...
{{--<link href="{{ asset('modules/admin/assets/css-rtl/dark-boxed.css') }}" rel="stylesheet"><!---Skinmodes css-->--}}
{{--<link href="{{ asset('modules/admin/assets/css-rtl/skin-modes.css') }}" rel="stylesheet" /><!--- Animations css-->--}}
